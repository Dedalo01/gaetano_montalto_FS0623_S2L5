...
for (const animal of pets) {
  console.log("ES1.", animal);
}

/* ESERCIZIO 2
    Scrivi del codice per ordinare alfabeticamente gli elementi dell'array "pets".
*/
console.log("ES2.", pets.sort());
...
console.log(pets.push(firstAnimal));
...
cars[0]["licensePlate"] = "FD629AL";
cars[1]["licensePlate"] = "FC723PL";
cars[2]["licensePlate"] = "AK456DD";
...
console.log("ES10.", positionsArray);
